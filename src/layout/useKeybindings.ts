...
export function useKeybindings(
  ...
  opts: { onNewTab?: () => void; onSplit?: (down: boolean) => void; onToggleDashboard?: () => void; onOpenProject?: () => void; onOpenWorkspaces?: () => void; onOpenSettings?: () => void; onToggleBell?: () => void; onClose?: () => void; onToggleCanvas?: () => void } = {},
) {
  useEffect(() => {
  ...
  }, [dispatch, opts.onNewTab, opts.onSplit, opts.onToggleDashboard, opts.onOpenProject, opts.onOpenWorkspaces, opts.onOpenSettings, opts.onToggleBell, opts.onClose, opts.onToggleCanvas]);
}
